...
class NominaController extends Controller
{
    public function crearNominaElectronica(Request $request)
    {
        ...
        return response()->json([
            ...
            'nombre_xml'      => $xmlFirmado['nombre_xml'],
            'nombre_zip'      => $xmlFirmado['nombre_zip'],
            'zip_base64'      => $xmlFirmado['zip_base64'],
            'dian_request'    => $response,
            'dian_response'   => $respuestaDian,
        ], 200);
    }
    ...
    function nombre_xml($nitObligado, $yearXml, $sequence)
    { //nit del sujeto obligado no se si es la empresa o el empleado
    ...
    function nombre_zip($nitObligado, $yearXml, $sequence)
    { //nit del sujeto obligado no se si es la empresa o el empleado
        $formattedNit = str_pad($nitObligado, 10, '0', STR_PAD_LEFT);
        $codigoPT = '000';
        $yearSuffix = substr($yearXml, -2);
